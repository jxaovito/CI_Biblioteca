...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('geral/mostra_edicao_livros/'.$livro['id_livro']) ?>"
            ...
            <a href="<?php echo site_url('geral/mostra_cadastro_livros'); ?>"><button class="btn btn-primary">Cadastrar um novo livro</button></a>
